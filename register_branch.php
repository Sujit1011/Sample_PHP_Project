...
<head>
	...
	<body>
		...
		<div class="container register-form">
            <div class="form">
                <div class="note">
                    <p>Register/Update Branch Details.</p>
                </div>
				...
				<form action="edit_branch.php" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="branch_city" class="form-control" placeholder="Branch City " value=""/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" name="assets" class="form-control" placeholder="Assets" value=""/>
                            </div>
                        </div>
                    </div>
					<center>
