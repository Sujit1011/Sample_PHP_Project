...
<div class="container register-form">
            <div class="form">
                <div class="note">
                    <p>Register/Update Customer Details.</p>
                </div>
				...
				<form action="edit_customer.php" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="customer_city" class="form-control" placeholder="Customer City " value=""/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" name="customer_street" class="form-control" placeholder="Customer Street " value=""/>
                            </div>
                        </div>
                    </div>
					<center>
